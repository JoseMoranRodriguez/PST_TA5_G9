...
public class AdminSQLiteOpenHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("insert into userdata values ('001', 'admin', 'admin', 'Alejandro', 'Guerra'," +
                "'aguerra@gmail.com','0971236690', 1)");
        db.execSQL("insert into userdata values ('002', 'user', 'password', 'Jose', 'Moran'," +
                "'gmoran@gmail.com','0977702549', 3)");
        db.execSQL("insert into userdata values ('003', 'barber', '1234', 'John', 'Barbery'," +
                "'jbarbery@gmail.com','0998457236', 2)");
        db.execSQL("insert into userdata values ('004', 'nei', 'dav', 'Neisser', 'Davila'," +
                "'ndavila@gmail.com','0989654257', 4)");
